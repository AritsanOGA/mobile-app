...
@override Widget build(BuildContext context) { return SafeArea(child: Scaffold(appBar: _buildAppBar(context), body: Container(width: double.maxFinite, padding: EdgeInsets.symmetric(vertical: 20.v), child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [SizedBox(height: 20.v), Expanded(child: SingleChildScrollView(child: SizedBox(height: 794.v, width: double.maxFinite, child: Stack(alignment: Alignment.topCenter, children: [CustomImageView(imagePath: ImageConstant.imgRectangle12, height: 78.v, width: 430.h, alignment: Alignment.bottomCenter), _buildJobListing(context)]))))])), bottomNavigationBar: Padding(padding: EdgeInsets.only(left: 36.h, right: 25.h), child: _buildBottomBar(context)))); } 
/// Section Widget
...
/// Section Widget
Widget _buildJobListing(BuildContext context) { return Align(alignment: Alignment.topCenter, child: Padding(padding: EdgeInsets.only(left: 25.h, right: 25.h, bottom: 74.v), child: ListView.separated(physics: NeverScrollableScrollPhysics(), shrinkWrap: true, separatorBuilder: (context, index) {return SizedBox(height: 25.v);}, itemCount: 7, itemBuilder: (context, index) {return JoblistingItemWidget();}))); } 
/// Section Widget
