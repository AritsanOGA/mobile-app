...
class AuthState with _$AuthState {
  ...
  CandidateProfileEntity?  candidateProfile,
    ...
    @Default(ViewState.idle) ViewState checkEmailState,
    @Default(ViewState.idle) ViewState candidateSearchState,
    @Default(ViewState.idle) ViewState checkPhoneState,
     @Default(ViewState.idle) ViewState hireMeState,
