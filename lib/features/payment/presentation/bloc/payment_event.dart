...
class PaymentEvent with _$PaymentEvent {
  ...
  const factory PaymentEvent.getInvoiceWithIdentity(String identity) =
      _GetInvoiceWithIdentity;
  const factory PaymentEvent.getAllInvoice() = _GetAllInvoice;
  const factory PaymentEvent.getNoOfCandidate(String jobId) = _GetNoOfCandidate;
