...
class AddAwardsPage extends HookWidget {
  const AddAwardsPage({super.key});
    ...
    return Scaffold(
      ...
      body: BlocConsumer<CandidatesBloc, CandidatesState>(
        listener: (context, state) {
          if (state.addAwardsState == ViewState.success) {
            Navigator.pushNamed(
              context,
          ...
          } else if (state.addAwardsState == ViewState.failure) {
            ...
            child: Column(
              ...
              children: [
                ...
                CustomElevatedButton(
                  width: 150,
                  isBusy: state.addAwardsState == ViewState.loading,
                  onPressed: () {
