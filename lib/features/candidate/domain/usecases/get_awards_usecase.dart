...
class GetAwardsUsecase implements UseCase<List<GetAwardEntity>, NoParams> {
  GetAwardsUsecase(this.repository);
  final CandidateRepository repository;
  @override
  Future<Either<Failure, List<GetAwardEntity>>> call(NoParams params) {
